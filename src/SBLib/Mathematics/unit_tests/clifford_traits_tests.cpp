...
static_assert(alternating_traits<1,2, true>::sign == +1, "Invalid wedge product sign");
static_assert(alternating_traits<2,1, true>::sign == -1, "Invalid wedge product sign");
static_assert(alternating_traits<1,2, false>::sign == -1, "Invalid wedge product sign");
static_assert(alternating_traits<2,1, false>::sign == +1, "Invalid wedge product sign");


static_assert(reversion_conjugacy_traits<0>::sign == +1, "Invalid reversion conjugacy sign");
static_assert(reversion_conjugacy_traits<1>::sign == +1, "Invalid reversion conjugacy sign");
static_assert(reversion_conjugacy_traits<3>::sign == -1, "Invalid reversion conjugacy sign");
static_assert(reversion_conjugacy_traits<7>::sign == -1, "Invalid reversion conjugacy sign");
